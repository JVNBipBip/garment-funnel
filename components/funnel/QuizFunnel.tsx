...
function QuestionStep({
  ...
  return (
    <div className="py-8">
      <h2 className="text-3xl md:text-4xl font-medium font-figtree text-neutral-900 mb-3">{title}</h2>
      <p className="text-neutral-500 text-lg mb-8 font-figtree">{subtitle}</p>
        ...
        {options.map((opt) => {
          ...
          return (
            <button
              ...
              className={`flex items-center p-6 rounded-2xl border-2 transition-all duration-200 text-left w-full group ${
                isSelected
            ...
            >
              ...
              <span className="font-medium text-neutral-900 flex-grow font-figtree text-lg">{opt.label}</span>
              {isSelected && (
    ...
    <div className="py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        {options.map((opt) => {
          ...
          return (
            ...
            >
              <div
                className={`w-6 h-6 rounded-md border mr-4 flex items-center justify-center transition-colors ${
              ...
              <span className="font-medium text-neutral-900 font-figtree text-lg">{opt.label}</span>
            </button>
          )
        })}
      </div>
      ...
      <div className="flex justify-end">
        <button
          ...
          className={`inline-flex items-center justify-center h-14 px-8 rounded-full font-medium text-base transition-all ${
            value.length > 0
