      ...
      <div className="mx-auto max-w-7xl px-8 py-24 pt-16">
        <div className="grid grid-cols-12 gap-5 gap-y-16 items-center">
          <div className="col-span-12 md:col-span-6 relative z-10">
            ...
            >
              Your next collection <br />
              <span className="text-neutral-400">starts with one sample.</span>
            </motion.h1>
            ...
            >
              Heavyweight blanks that feel retail-ready out of the box. Order a sample pack, compare it to what you're using now — and see the difference before you commit.
            </motion.p>
