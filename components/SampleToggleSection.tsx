...
import { ArrowRight, Package, PenTool } from "lucide-react"
...
export const SampleToggleSection = () => {
    const [activeTab, setActiveTab] = useState("pre-packaged")
    ...
    return (
        <section className="w-full py-24 bg-white" id="samples">
            <div className="mx-auto max-w-5xl px-8">
                ...
                <Tabs defaultValue="pre-packaged" className="w-full flex-col items-center" onValueChange={setActiveTab}>
